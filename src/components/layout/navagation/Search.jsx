      ...
      <div className='w-full max-w-lg lg:max-w-xs'>
        ...
        <div className='relative'>
          ...
          <input
            ...
            ref={inputRef}
            className='block w-full rounded-md border border-transparent bg-gray-800 py-2 pl-10 pr-3 leading-5 text-gray-400 placeholder-gray-400 focus:border-stardata-700 focus:bg-stardata focus:text-white focus:outline-none focus:ring-stardata-700 sm:text-sm'
